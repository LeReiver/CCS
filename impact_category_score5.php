...
include_once('includes/impact_category_score_code5.php');
...
<div id="form_content">
    ...
    <form method="POST" action="impact_category_score5.php">
        <!-- User form-->
        ...
        <table class="form_table" style="margin: 10px 0 0 60px;">
            ...
            <tr><td></td><td><?php echo "*" ?></td><td><?php echo "*" ?></td>
