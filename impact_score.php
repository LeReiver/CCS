...
include_once('includes/impact_score_code.php');
    ...
    <div id="form_content">
        ...
        <form method="POST" action="function_processes.php">
            ...
            <table class="form_table">
                ...
                <tr>
                    <!--  Input label -->
                    <th class="form_label">Impact Category: </th>
                    <!-- User selector gets essential functions -->
                    <td colspan="2" class="form_input"> <?php get_impact_category() ?></td>
                </tr>
                <tr>
                    <!--  Input label -->
                    <th class="form_label">RTO: </th>
                    <!-- User selector gets essential functions -->
                    <td colspan="2" class="form_input"> <?php get_rto() ?></td>
                </tr>
                <tr>
                    <!--  Input label -->
                    <th class="form_label">Impact Rating: </th>
                    <!-- User selector gets essential functions -->
                    <td colspan="2" class="form_input"> <?php get_rating() ?></td>
                </tr>
                ...
                <div class="submit_table">
                    <tr>
                        ...
                        <td class="data_submit"> <div><input type="submit" value="SUBMIT"
                                name="<?php echo FUNC_PROCESS_SUBMIT_BUTTON_VALUE ?>" style='width: 100px;margin-left: 250px;'></div></td>
                    </tr>
                    <tr>
                        <td></td>
                        <!-- Reset button -->
